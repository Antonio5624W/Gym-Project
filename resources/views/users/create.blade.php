...
<body class="bg-light">
                    ...
                    <div class="card-body">
                        <form action="{{ route('users.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="email" name="email" class="form-control" placeholder="empleado@gym.com"
                                    required>
                                @error('email')
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    <!-- Agregamos un ID al input para que JavaScript lo encuentre -->
                                    <input type="password" name="password" id="passwordInput" class="form-control"
                                        placeholder="Mínimo 6 caracteres" required>

                                    <!-- Botón del ojito pegado al input -->
    ...
    <script>
        // Seleccionamos el botón y el campo de contraseña
        const togglePassword = document.querySelector('#togglePassword');
        const passwordInput = document.querySelector('#passwordInput');

        // Le decimos qué hacer cuando le den clic al botón
        togglePassword.addEventListener('click', function() {
            // Revisamos si actualmente está oculto o visible
            const type = passwordInput.getAttribute('type') === 'password' ? 'text' : 'password';

            // Cambiamos el tipo de input
            passwordInput.setAttribute('type', type);

            // Cambiamos el emoji del botón para que sea más interactivo
